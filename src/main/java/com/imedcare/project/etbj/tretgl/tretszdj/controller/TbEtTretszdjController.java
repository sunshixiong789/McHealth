package com.imedcare.project.etbj.tretgl.tretszdj.controller;
 ...
 */
@Controller
@RequestMapping("/tretgl/tretszdj")
public class TbEtTretszdjController extends BaseController {
    private String prefix = "etbj/tretgl/tretszdj";

    @Autowired
    private TbIEtTretdjService etTretdjService;

    @RequiresPermissions("tretgl:tretszdj:view")
    @GetMapping()
    public String tretdj() {
        return prefix + "/tretszdj";
    }
     ...
     * 查询体弱儿童随诊登记列表
     */
    @RequiresPermissions("tretgl:tretszdj:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出体弱儿童随诊登记列表
     */
    @RequiresPermissions("tretgl:tretszdj:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存体弱儿童随诊登记
     */
    @RequiresPermissions("tretgl:tretszdj:add")
    @Log(title = "体弱儿童随诊登记", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
     ...
     * 修改保存体弱儿童随诊登记
     */
    @RequiresPermissions("tretgl:tretszdj:edit")
    @Log(title = "体弱儿童随诊登记", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
     ...
     * 删除体弱儿童随诊登记
     */
    @RequiresPermissions("tretgl:tretszdj:remove")
    @Log(title = "体弱儿童随诊登记", businessType = BusinessType.DELETE)
    @PostMapping("/remove")
    @ResponseBody
