...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '妇幼保健院',   0, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
insert into sys_dept values(101,  100, '0,100',      '信息科', 1, 'admin', '15888888888', 'admin@qq.com', '0', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00');
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  101, 'superAdmin', '超级管理员', '00', 'superAdmin@163.com', '15888888888', '1', '', 'c448a02d336b5d4ea05df3554f85e064', 'adb481', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');
insert into sys_user values(2,  101, 'admin',    '管理员', '00', 'admin@qq.com',  '15666666666', '1', '', 'e1b4e1334c5d678df03378da53cc3f7b', '2103d2', '0', '0', '127.0.0.1', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');
...
insert into sys_job values(2, '系统默认（有参）', 'DEFAULT', 'ryTask.ryParams(\'paramsInfo\')',  '0/15 * * * * ?', '3', '1', '1', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
insert into sys_job values(3, '系统默认（多参）', 'DEFAULT', 'ryTask.ryMultipleParams(\'paramsInfo\', true, 2000L, 316.50D, 100)',  '0/20 * * * * ?', '3', '1', '1', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒： 新版本发布啦', '2', '新版本内容', '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');
insert into sys_notice values('2', '维护通知：系统凌晨维护', '1', '维护内容',   '0', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '管理员');
